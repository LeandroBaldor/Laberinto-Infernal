export class ComingSoonScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.add.text(width / 2, height / 2 - 60, 'Próximamente niveles nuevos', {
    ...
    btn.on('pointerover', () => btn.setStyle({ color: '#ffffff', backgroundColor: '#006600' }))
    btn.on('pointerout',  () => btn.setStyle({ color: '#00ff00', backgroundColor: '#003300' }))
    btn.on('pointerdown', () => {
